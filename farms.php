...
$sql = "SELECT farms.*, users.first_name, users.last_name FROM farms LEFT JOIN users ON users.id = farms.user_id 
        WHERE farms.status = 'verified' AND users.status = 'active'";
$stmt = $pdo->query($sql);
...
<body>
                            ...
                            <tbody id="table-body">
                                ...
                                ?>
                                        <tr>
                                            ...
                                            <input type="hidden" value="<?= $row->farm_id ?>">
                                            <input type="hidden" value="<?= $row->farm_name ?>">
                                            ...
                                            <td>
                                                ...
                                                <button class="Button-Green-Icon" title="Open Location">
    ...
    <script src="Javascript/farms.js"></script>
</body>
